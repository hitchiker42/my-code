...
//index should usually (if not always) be 0, for my purposes.
ft_face_wrapper* ft_face_wrapper_init(FT_Library lib, const char *filename,
  ...
  error = FT_Set_Char_Size(
    face,
    /* width/height in 1/64th of points */
    0, ptsize*64,
    /* horizontal/vertical device resolution dpi/ppi (default 72)*/
    0,0);   
