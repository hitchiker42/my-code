...
(defstruct match-data
  ...
  (match-start nil :type (or fixnum nil))
  (match-end nil :type (or fixnum nil))
  (register-groups-start nil :type (or vector nil))
  (register-groups-end nil :type (or vector nil)))
