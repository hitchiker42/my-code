...
my($copy,$rand,$update,$prefix,$dir,$new_dir,$verbose,
...
# }
my $args = join(" ",@ARGV);
my $shortopts = "c,h,m,u,p:,d:,n:,e,r,s:,v";
my $longopts = "copy,help,move,update,prefix:,dir:,new_dir:,ext,suffix:,verbose";
...
while(1){
    given($opts[0]){
        ...
        when(/-v|--verbose/){$say=sub {say @_;};$verbose=1;shift @opts;}
