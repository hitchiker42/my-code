...
Edits:
09/24/2012 R. Daniel Bergeron, CS Dept, Univ of New Hampshire
    1. Corrected incorrect assignment to last_live_text about line 950
    2. Avoided warnings of hiding of two virtual functions by adding "using"
       statements; this should cause override, rather than hiding
          using GLUI_Node::add_control;  around line 708
          using GLUI_Control::get_id;    around line 1326
...
protected:
    ...
    /*********** Controls ************/
    using GLUI_Node::add_control;  // rdb
...
public:
    ...
    using GLUI_Control::get_id;   // using added by rdb: 9/24/2012
