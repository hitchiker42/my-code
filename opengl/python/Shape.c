...
/*--- Type declarations ---*/
struct __pyx_obj_5Shape_Vertex;
...
static PyTypeObject *__pyx_ptype_5Shape_Vertex = 0;
...
static int __pyx_pf_5Shape_6Vertex___cinit__(struct __pyx_obj_5Shape_Vertex *__pyx_v_self, PyObject *__pyx_v_pos, PyObject *__pyx_v_color); /* proto */
static PyObject *__pyx_tp_new_5Shape_Vertex(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_5Shape_6Vertex_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_5Shape_6Vertex_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("Shape.Vertex.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5Shape_6Vertex___cinit__(((struct __pyx_obj_5Shape_Vertex *)__pyx_v_self), __pyx_v_pos, __pyx_v_color);
...
static int __pyx_pf_5Shape_6Vertex___cinit__(struct __pyx_obj_5Shape_Vertex *__pyx_v_self, PyObject *__pyx_v_pos, PyObject *__pyx_v_color) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  float __pyx_t_1[3];
  float __pyx_t_2[4];
 ...
 *     #enddef
 */
  if (unlikely(__Pyx_carray_from_py_float(__pyx_v_pos, __pyx_t_1, 3) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * #endclass
 */
  if (unlikely(__Pyx_carray_from_py_float(__pyx_v_color, __pyx_t_2, 4) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  memcpy(&(__pyx_v_self->color[0]), __pyx_t_2, sizeof(__pyx_v_self->color[0]) * (4));
 ...
 */
      __pyx_t_11 = __pyx_PyFloat_AsFloat(__pyx_v_item); if (unlikely((__pyx_t_11 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_tp_new_5Shape_Vertex(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o;
  ...
  if (unlikely(__pyx_pw_5Shape_6Vertex_1__cinit__(o, a, k) < 0)) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_5Shape_Vertex(PyObject *o) {
...
static PyMethodDef __pyx_methods_5Shape_Vertex[] = {
  {0, 0, 0, 0}
};

static PyTypeObject __pyx_type_5Shape_Vertex = {
  PyVarObject_HEAD_INIT(0, 0)
  "Shape.Vertex", /*tp_name*/
  sizeof(struct __pyx_obj_5Shape_Vertex), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_5Shape_Vertex, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_5Shape_Vertex, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_5Shape_Vertex, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initShape(void); /*proto*/
PyMODINIT_FUNC initShape(void)
#else
PyMODINIT_FUNC PyInit_Shape(void); /*proto*/
PyMODINIT_FUNC PyInit_Shape(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_Shape(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "Shape")) {
      if (unlikely(PyDict_SetItemString(modules, "Shape", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_5Shape_Vertex) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_5Shape_Vertex.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "Vertex", (PyObject *)&__pyx_type_5Shape_Vertex) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_5Shape_Vertex = &__pyx_type_5Shape_Vertex;
  /*--- Type import code ---*/
